...
namespace RECode.Editor.BTEditor
{
    ...
    public class BTNodeSearchWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        public List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            ...
            entries.Add(MakeEntry("事件节点 Action", E_BTNodeType.Action, 2));
            entries.Add(MakeEntry("条件节点 Condition", E_BTNodeType.Condition, 2));
            entries.Add(MakeEntry("打印节点 Debug", E_BTNodeType.Debug, 2));
            return entries;
        }
